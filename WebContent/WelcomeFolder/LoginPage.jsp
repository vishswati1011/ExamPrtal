            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="<%=request.getContextPath() %>/StudentLogin" method="get">
                            ...
                            <div id="register-link" class="text-right" align="right">
                                <a href="<%=request.getContextPath() %>/AdminPanel/StudentControll/StudentRegistration.jsp" class="text-info">New Student Register here</a>
                            </div>
                        </form>
